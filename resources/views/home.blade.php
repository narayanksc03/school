...
<x-layout>
    ...
    <!-- Carousel wrapper -->
    <div class="relative h-56 overflow-hidden rounded-base  md:h-screen ">
         <!-- Item 1 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
            <img src="https://cdn.pixabay.com/photo/2023/03/14/09/56/sculpture-7851967__340.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Anique image">
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="https://cdn.pixabay.com/photo/2023/03/14/09/56/stone-7851968__340.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Stone Lion">
        </div>
        <!-- Item 3 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="https://cdn.pixabay.com/photo/2023/03/14/09/50/nepal-7851954__340.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Pagoda style temple">
        </div>
        <!-- Item 4 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="https://cdn.pixabay.com/photo/2023/03/14/09/54/stone-7851963__340.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="a girl drinking water">
        </div>
        <!-- Item 5 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="https://cdn.pixabay.com/photo/2023/03/14/09/45/nepali-7851939__340.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Old House">
        </div>
    </div>
    <!-- Slider indicators -->
